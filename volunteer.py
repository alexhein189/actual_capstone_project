...
class volunteer:
    ...
    def __init__(self, name:str, username:str, id_code:int, timestamp:available_time, available_location:address_availablity):
        self.name = name
...
available_time_of_vol_a = available_time(["Tuesdays", "Thursdays"], ["08:00-09:00","09:00-10:00","10:00-11:00","12:00-1:00"])
