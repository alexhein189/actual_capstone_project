...
john_walker = shop_keeper("John Walker", "SH34522", 51.3491122,-0.2356431, {"paracetemol":None, "cough drops":None, "Advil":None, "vitamin":None},main_grid, main_users_dictionary)
hoodle_shop = shop_keeper("Hoodle Groceries", "SH23943", 51.1410572,-0.125447, {"bread":None, "biscuits":None, "pasta":None, "cough drops":None},main_grid, main_users_dictionary)
...
volunteer_e = volunteer_var("Robert","robert101", "VO54761", 51.3268855,-0.2256531,{6:[(10, 12), (14,16)],3:[(10, 12), (14,16)]}, 10,main_grid, main_users_dictionary)
...
alice_vulnerable.request_items("VP78743",["biscuits","tomatoes","rice", "paracetemol", "bread"], test_start_date, today+datetime.timedelta(days=1), 1, priority_queue)
kate_vulnerable.request_items("VP33219",["pasta","tomatoes","cough drops", "paracetemol", "bread"], test_start_date_1, today+datetime.timedelta(days=2), 8, priority_queue)
